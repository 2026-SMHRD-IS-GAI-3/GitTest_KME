...
public class CommunityUpdateService extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String title = String.valueOf(reqMap.get("title"));
            ...
            if (result > 0) {
                ...
                resultMap.put("message", "게시글 수정 성공");
            } else {
                resultMap.put("success", false);
                resultMap.put("message", "게시글 수정 실패 또는 수정 권한이 없습니다.");
            }
            ...
            resultMap.put("success", false);
            resultMap.put("message", "게시글 수정 중 오류가 발생했습니다.");
        }
